...
*/
			    pline("%sは%sをあなたの%sからぐいとひっぱった！", Monnam(mtmp),
				  the_weapon, hand);
...
*/
			    pline("%sは%sを%sに引き落した！", Monnam(mtmp),
