...
*/
	    if(IS_ROCK(levl[u.ux][u.uy].typ)) You("石につつまれた．");
	}
	return(TRUE);
}
...
*/
	    	verbalize("おい！だれがこの%sをここに置いて行ったんだ？", mimic_obj_name(&youmonst));
