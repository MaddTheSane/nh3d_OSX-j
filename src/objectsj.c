...
AMULET("遠視の魔除け",                "丸い魔除け", TELEPAT, 175),
...
POTION("能力獲得の薬",           "ルビー色の",  1, 0, 42, 300, CLR_RED),
POTION("能力回復の薬",        "ピンク色の",  1, 0, 40, 100, CLR_BRIGHT_MAGENTA),
POTION("混乱の薬",            "オレンジ色の",  1, CONFUSION, 42, 100, CLR_ORANGE),
POTION("盲目の薬",            "黄色の",  1, BLINDED, 40, 150, CLR_YELLOW),
POTION("麻痺の薬",           "エメラルド色の",  1, 0, 42, 300, CLR_BRIGHT_GREEN),
POTION("加速の薬",            "暗緑色の",  1, FAST, 42, 200, CLR_GREEN),
POTION("浮遊の薬",             "シアン色の",  1, LEVITATION, 42, 200, CLR_CYAN),
POTION("幻覚の薬",      "水色の",  1, HALLUC, 40, 100, CLR_CYAN),
POTION("透明の薬", "明るい青色の",  1, INVIS, 40, 150, CLR_BRIGHT_BLUE),
POTION("可視の薬",       "マゼンダ色の",  1, SEE_INVIS, 42, 50, CLR_MAGENTA),
POTION("回復の薬",          "赤紫色の",  1, 0, 57, 100, CLR_MAGENTA),
POTION("超回復の薬",          "暗褐色の",  1, 0, 47, 100, CLR_RED),
...
POTION("物体を探す薬",      "煙がでている",  1, 0, 42, 150, CLR_GRAY),
POTION("魔力の薬",          "曇っている",  1, 0, 42, 150, CLR_WHITE),
POTION("睡眠の薬",       "沸騰している",  1, 0, 42, 100, CLR_GRAY),
POTION("完全回復の薬",          "黒い",  1, 0, 10, 200, CLR_BLACK),
POTION("変化の薬",            "金色の",  1, 0, 10, 200, CLR_YELLOW),
POTION("酔っぱらいの薬",                 "茶色の",  0, 0, 42,  50, CLR_BROWN),
POTION("病気の薬",              "発泡している",  0, 0, 42,  50, CLR_CYAN),
POTION("フルーツジュース",            "陰気な色の",  0, 0, 42,  50, CLR_BLACK),
POTION("酸の薬",                  "白い",  0, 0, 10, 250, CLR_WHITE),
POTION("油",                   "濃黒の",  0, 0, 30, 250, CLR_BROWN),
/* fixed description
 */
POTION("水",                 "無色の",  0, 0, 92, 100, CLR_CYAN),
#undef POTION
